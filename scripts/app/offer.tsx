...
const OfferScreen = () => {
  const products = [
    { id: 1, name: "Barnyard", subName: "Kuthiraivali", rating: 4.3, weight: "215kg", originalPrice: "₹110", discountedPrice: "₹55", discountText: "50% Off", image: require("../assets/images/barnyard.png") },
    { id: 2, name: "Foxtail", subName: "Thinai", rating: 4.5, weight: "200kg", originalPrice: "₹150", discountedPrice: "₹75", discountText: "50% Off", image: require("../assets/images/foxtail.png") },
  ];
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.searchContainer}>
        ...
        <TextInput style={styles.searchInput} placeholder="Search for all Product" />
      </View>

      {/* Best Offer Banner */}
      <View style={styles.bannerContainer}>
        <Image source={require("../assets/images/farmer.png")} style={styles.bannerImage} />
