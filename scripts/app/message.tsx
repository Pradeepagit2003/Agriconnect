...
// Import Icons
const backIcon = require("../assets/images/back.jpeg");
...
const messages = [
  ...
  { id: 2, name: "Arun", message: "That’s a bit high. Can you...", time: "8:00 am", unread: 0 },
];
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.searchContainer}>
        ...
        <TextInput style={styles.searchInput} placeholder="Search Messages" placeholderTextColor="#888" />
      </View>
...
const styles = StyleSheet.create({
  ...
  // Header Styles
  header: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", padding: 15, backgroundColor: "#E6F4E6" },
  backIcon: { width: 20, height: 20 },
  title: { fontSize: 20, fontWeight: "bold", color: "#333" },
  profileIcon: { width: 30, height: 30, borderRadius: 15 },

  // Search Bar
  searchContainer: { flexDirection: "row", backgroundColor: "#F2F2F2", margin: 15, borderRadius: 20, padding: 10, alignItems: "center" },
  searchIcon: { width: 18, height: 18, marginRight: 10 },
  searchInput: { flex: 1, fontSize: 16 },

  // Messages List
  messageList: { flex: 1 },
  messageItem: { flexDirection: "row", alignItems: "center", padding: 15, borderBottomWidth: 1, borderColor: "#EEE" },
  ...
  unreadBadge: { backgroundColor: "green", borderRadius: 10, width: 20, height: 20, justifyContent: "center", alignItems: "center" },
  unreadText: { color: "#fff", fontSize: 12, fontWeight: "bold" },

  // Bottom Navigation
  bottomNav: { flexDirection: "row", backgroundColor: "#fff", borderTopWidth: 1, borderColor: "#DDD", paddingVertical: 10, justifyContent: "space-around", alignItems: "center", height: 70 },
